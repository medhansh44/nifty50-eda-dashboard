# BUILD_MARKER: layout-fix-v3 | clean legends | responsive takeaway cards | histogram fix retained
...
if processed_path is None:
    st.error(
        ...
        "`NIFTY50_processed(3).csv`, or `processed_data.csv` beside `app.py`."
    )
    st.stop()
...
with st.sidebar:
    ...
    st.caption("Build: layout-fix-v3")
